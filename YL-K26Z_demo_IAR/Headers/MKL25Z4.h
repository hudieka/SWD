...
/** Peripheral PTE base pointer */
#define PTE                                      ((GPIO_MemMapPtr)PTE_BASE)
/** Array initializer of GPIO peripheral base pointers */
...
/** Peripheral PORTA base pointer */
#define PORTA                                    ((PORT_MemMapPtr)PORTA_BASE)
/** Peripheral PORTB base address */
#define PORTB_BASE                               (0x4004A000u)
/** Peripheral PORTB base pointer */
#define PORTB                                    ((PORT_MemMapPtr)PORTB_BASE)
/** Peripheral PORTC base address */
#define PORTC_BASE                               (0x4004B000u)
/** Peripheral PORTC base pointer */
#define PORTC                                    ((PORT_MemMapPtr)PORTC_BASE)
/** Peripheral PORTD base address */
#define PORTD_BASE                               (0x4004C000u)
/** Peripheral PORTD base pointer */
#define PORTD                                    ((PORT_MemMapPtr)PORTD_BASE)
/** Peripheral PORTE base address */
#define PORTE_BASE                               (0x4004D000u)
/** Peripheral PORTE base pointer */
#define PORTE                                    ((PORT_MemMapPtr)PORTE_BASE)
/** Array initializer of PORT peripheral base pointers */
...
/** Peripheral SIM base pointer */
#define SIM                                      ((SIM_MemMapPtr)SIM_BASE)
/** Array initializer of SIM peripheral base pointers */
